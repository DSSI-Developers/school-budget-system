...
export class ManageSubEquipmentComponent implements OnInit {
  ...
  addSubEupqment() {
    ...
    this.listOfSubProject.push(
      ...
      { no: index + this.listOfSubProject.length, list: this.subEquipment.value.equipmentName, price: this.subEquipment.value.pricePerunit, unit: this.subEquipment.value.unit, budget: this.subEquipment.value.budget, edit: 'edit', delete: 'delete' }
      );
  }
